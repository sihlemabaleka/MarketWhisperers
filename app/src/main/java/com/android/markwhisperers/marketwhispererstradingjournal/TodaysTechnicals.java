 ...
 */
public class TodaysTechnicals extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new MyTradeRecyclerViewAdapter(this, trades, "active", snapshots);
        ...
        mDatabase.child("users").child("active").addValueEventListener(new ValueEventListener() {
            @Override
